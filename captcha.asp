...
const i_bgcolor="cccccc"		'bg color RGB
const i_noisecolor="333333"
const i_noisefrequency=0.07		'between 0 and 1
const i_offsetcolor=45

const i_mingridwidth=25
const i_maxgridwidth=35
const i_mingridheight=26
const i_maxgridheight=32
